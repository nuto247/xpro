...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="default-01" name="product_name" placeholder="Product Name">
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="default-01" name="product_price" placeholder="Product Price">
    </div>
</div>
</div>
<br>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control no-resize" name="product_description" id="default-textarea">Large text area content</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
