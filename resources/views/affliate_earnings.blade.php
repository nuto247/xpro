                                        ...
                                        <div class="col-xxl-8">
                                            <div class="card card-full">
                                                ...
                                                <div class="nk-tb-list mt-n2">
                                                    ...
                                                    @if($affiliateEarnings->isEmpty())
        <p>No affiliate earnings found for the user.</p>
    @else
                                                    @foreach($affiliateEarnings as $earning)
                                                        ...
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <div class="user-card">
                                                                <div class="user-avatar sm bg-purple-dim">
                                                                    <span>AB</span></div>
                                                                <div class="user-name"><span class="tb-lead">{{ $earning->refferal_profit }}</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="tb-sub">{{ $earning->created_at }}</span></div>
