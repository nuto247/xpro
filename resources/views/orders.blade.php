                                                    ...
                                                    @foreach ($orders as $order)
                                                        <div class="nk-tb-item">
                                                            ...
                                                            <div class="nk-tb-col tb-col-md"><span
                                                                    class="tb-sub">{{ $order->created_at->toDateTimeString() }}</span></div>
                                                            <div class="nk-tb-col"><span
                                                                    class="tb-sub tb-amount">{{ $order->currency }}{{ $order->amount }}
                                                                    <span></span></span></div>
                                                            <div class="nk-tb-col">
                                                                ...
                                                                @elseif ($order->status == 'pending')
                                                                    <span
                                                                        class="badge badge-dot badge-dot-xs bg-info">Pending</span>
                                                                @endif
