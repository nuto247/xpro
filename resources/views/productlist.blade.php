                                                    ...
                                                    <tbody>
                                                        @foreach ($products as $product)
                                                            <tr>
                                                                ...
                                                                <td><img src="{{ asset('images/' . $product->image_path) }}"
                                                                        width="100px" alt="Image"></td>
                                                                <td>
                                                                    <button class="btn btn-xs btn-primary copyTextInput"
                                                                        data-link="{{ route('productAfflicateCode',
                                                                            $product->id . '-' . Auth::user()->affiliate_code) }}"
                                                                        onclick="copyToClipboard($(this).data('link'))">
